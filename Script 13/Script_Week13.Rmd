...
You don't have to go through the hassle of commenting out each line of code. Simply select the lines of code,
and them press simultaneously on `Command + Shift + C (Mac)` or `Strg/Ctrl + Shift + C (Windows)` to comment or comment out the selected lines. 
</div>
